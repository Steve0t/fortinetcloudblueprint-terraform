...
set group-id ${var_ha_group_id}
set group-name ${lower(var_deployment_prefix)}
set priority ${var_ha_priority}
set tunnel-local ${var_local_port2_ip}
set tunnel-peer ${var_peer_port2_ip}
...
set gateway ${var_subnet6_gateway}
set device port2
next
end
...
set server ${var_fortigate_ip}
set port 443
set protocol HTTPS
set username ${var_admin_username}
set password ${var_admin_password}
set flag enable
end
